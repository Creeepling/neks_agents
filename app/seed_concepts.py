...
concepts_data = [
    {
        "property_id": "seed-property-1",
        "name": "Районный торговый центр «ЭкоЛайф»",
        "format_type": "Neighborhood Center",
    ...
    {
        "property_id": "seed-property-2",
        "name": "Ритейл-парк «МегаМолл»",
        "format_type": "Power Center",
    ...
    {
        "property_id": "seed-property-3",
        "name": "Торгово-развлекательный центр «Галактика»",
        "format_type": "Regional Mall",
    ...
    {
        "property_id": "seed-property-5",
        "name": "Стрит-ритейл кластер «Гурман Стрит»",
        "format_type": "Lifestyle Center",
